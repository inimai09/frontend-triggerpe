    ...
    <div className="flex flex-col min-h-screen bg-transparent">
      ...
      <section className="flex flex-col lg:flex-row w-full min-h-[90vh] items-center relative z-10 overflow-hidden">
        <div className="flex-1 flex flex-col justify-center px-12 lg:px-24 py-12 animate-in fade-in slide-in-from-left-8 duration-1000">
          ...
          <p className="text-lg text-[#00838F] mt-8 mb-10 max-w-xl font-bold animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            ...
            <CarouselContent>
              {weatherCards.map((card, idx) => (
                <CarouselItem key={idx}>
                  <Card className={`overflow-hidden border border-border shadow-lg bg-white border-t-[6px] ${card.border} rounded-2xl transform transition-transform duration-500 hover:scale-105`}>
      ...
      {/* How It Works */}
      <section className="py-24 px-12 bg-white/30 backdrop-blur-sm border-t border-white/20 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={idx} className="p-10 text-center bg-white border border-border shadow-sm rounded-xl btn-hover-effect">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className={`p-10 flex flex-col items-center bg-white border-2 rounded-2xl btn-hover-effect ${plan.badge ? 'border-primary shadow-xl scale-105' : 'border-border shadow-sm'}`}>
                ...
                <Button className="w-full rounded-full bg-primary hover:bg-primary/90 font-black h-12 text-white">
                  {plan.btn}
                </Button>
              </Card>
            ))}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            {[
              ...
              <AccordionItem key={i} value={`item-${i}`} className="bg-white/80 border-none rounded-xl px-6 shadow-sm mb-4 transition-all hover:bg-white animate-in fade-in slide-in-from-left duration-500" style={{ animationDelay: `${i * 100}ms` }}>
