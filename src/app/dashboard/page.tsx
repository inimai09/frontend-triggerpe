      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
            ...
            <div className="p-10 bg-black/40 border border-white/5 rounded-[3rem] w-full xl:w-auto btn-hover-effect">
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-white/40 text-[8px] font-black uppercase tracking-widest flex items-center gap-2">
                  <div className="p-1 bg-white/5 rounded-full border border-white/10 flex items-center justify-center shrink-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 w-full xl:w-auto">
              {[
                ...
                <div key={i} className="flex flex-col items-center p-6 rounded-full bg-black/40 border border-white/5 btn-hover-effect min-w-[120px]">
                  <div className="p-3 rounded-full bg-white/5 mb-3 border border-white/10 flex items-center justify-center shrink-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <Card key={i} className="card-neon-glow flex items-center p-8 gap-6 rounded-full btn-hover-effect">
              <div className={cn("p-4 rounded-full bg-black/40 border border-white/5 flex items-center justify-center shrink-0", stat.color)}>
        ...
        <Card className="card-neon-glow p-10 rounded-[3.5rem] space-y-10 border-none">
          <h2 className="text-2xl font-black text-white flex items-center gap-5 uppercase tracking-tighter font-headline">
            <div className="p-3 bg-primary/20 rounded-full border border-primary/30 flex items-center justify-center shrink-0">
