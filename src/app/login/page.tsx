                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Input placeholder="98765 43210" className="h-14 border-primary/20 bg-white/5 focus-visible:ring-primary rounded-xl font-bold text-white px-6 text-lg" maxLength={10} />
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between gap-2">
                      {otp.map((digit, i) => (
                        <Input
                          ...
                          className="w-12 h-16 text-center text-2xl font-black border-primary/20 bg-white/5 rounded-xl text-white focus:border-primary"
                          maxLength={1}
                        />
                      ))}
                    </div>
                ...
                {!otpSent ? (
                  <>
                    <div className="space-y-2">
                      ...
                      <Input placeholder="partner@triggerpe.com" className="h-14 border-primary/20 bg-white/5 focus-visible:ring-primary rounded-xl font-bold text-white px-6 text-lg" type="email" />
                    </div>
                    <Button onClick={handleSendOtp} className="w-full h-16 bg-primary hover:bg-primary/90 rounded-full font-black shadow-lg btn-hover-effect text-white uppercase text-lg" disabled={loading}>
                      {loading ? <Loader2 className="w-6 h-6 animate-spin mr-3" /> : "Send OTP"}
                    </Button>
