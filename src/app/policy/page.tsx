            ...
            <CardContent className="p-8 space-y-8 flex-1">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="p-4 bg-black/40 rounded-full border border-white/5 flex flex-col items-center text-center group btn-hover-effect">
            ...
            <Card className="card-neon-glow rounded-[2.5rem] border-none overflow-hidden">
              ...
              <CardContent className="p-6 space-y-4">
                {[
                  ...
                  <div key={i} className="p-5 bg-black/40 rounded-full border border-white/5 flex flex-col gap-1 btn-hover-effect">
