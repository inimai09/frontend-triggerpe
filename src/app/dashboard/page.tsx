      ...
      <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
        ...
        <Card className="card-neon-glow p-10 rounded-[2.5rem] border-none">
          <header className="flex flex-col gap-2">
            <h1 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter drop-shadow-sm">Welcome, {user.name}! 👋</h1>
            <div className="inline-flex items-center gap-3 w-fit px-5 py-2 rounded-full bg-primary/10 border border-primary/20">
              ...
              <p className="text-primary font-black uppercase tracking-widest text-[10px] icon-neon-glow">Active Parametric Monitoring</p>
            </div>
          </header>
        </Card>
          ...
          <CardContent className="p-10 flex flex-col xl:flex-row justify-between items-center gap-12">
            ...
            <div className="p-10 bg-black/40 border border-white/5 rounded-[3rem] w-full xl:w-auto btn-hover-effect">
              ...
              <div className="flex items-end gap-8">
                <span className="text-[80px] md:text-[100px] font-black text-white leading-none tracking-tighter drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]">31°</span>
                <div className="mb-4">
                  <p className="text-2xl md:text-3xl font-black text-primary uppercase tracking-tight">Cloudy</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 w-full xl:w-auto">
              {[
                ...
                <div key={i} className="flex flex-col items-center p-6 rounded-[2rem] bg-black/40 border border-white/5 btn-hover-effect min-w-[110px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <Card key={i} className="card-neon-glow flex items-center p-8 gap-6 rounded-[2.5rem] btn-hover-effect">
        ...
        <Card className="card-neon-glow p-10 rounded-[3rem] space-y-10 border-none">
          <h2 className="text-2xl font-black text-white flex items-center gap-4 uppercase tracking-tighter">
            <Activity className="w-8 h-8 text-primary icon-neon-glow" /> Live Trigger Monitor
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {[
              ...
              <div key={i} className="p-8 bg-black/40 border border-white/5 rounded-[2rem] space-y-6 btn-hover-effect">
                <div className="flex justify-between items-start">
                  <span className="text-sm font-black text-white/80 uppercase tracking-tight">{t.label}</span>
          ...
          <Card className="lg:col-span-2 card-neon-glow rounded-[3rem] overflow-hidden">
            ...
            <CardContent className="p-0">
              <div className="p-20 text-center">
                ...
                <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Payouts process automatically upon trigger validation.</p>
              </div>
            </CardContent>
          </Card>

          <Card className="card-neon-glow rounded-[3rem] overflow-hidden">
            <CardHeader className="border-b border-white/5 px-10 py-8 bg-white/5">
            ...
            <CardContent className="p-10 space-y-10">
              ...
              <div className="p-6 bg-black/40 border border-white/5 rounded-[2rem] space-y-5 btn-hover-effect">
                ...
                <Progress value={35} className="h-2 bg-white/5" indicatorClassName="bg-primary shadow-[0_0_10px_#00ACC1]" />
