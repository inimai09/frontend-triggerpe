  ...
  return (
    <aside className="w-[240px] min-w-[240px] max-w-[240px] bg-black/95 backdrop-blur-3xl border-r border-primary/20 h-screen flex flex-col sticky top-0 overflow-hidden z-50">
      ...
      <div className="p-3 mt-auto bg-black/40 border-t border-white/5 shrink-0">
        <div className="flex items-center gap-2.5 mb-2 p-2.5 bg-white/5 rounded-full border border-white/5 btn-hover-effect cursor-pointer">
        ...
        <Button 
          ...
          className="w-full flex items-center justify-start gap-2.5 px-4 py-1.5 text-destructive/50 hover:text-destructive hover:bg-destructive/10 rounded-full font-black transition-all duration-300 border border-transparent btn-hover-effect h-8"
        >
