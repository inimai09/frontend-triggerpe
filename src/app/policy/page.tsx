  ...
  return (
    <DashboardLayout>
      <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <CardContent className="p-16 space-y-16 flex-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={i} className="p-6 bg-white/5 rounded-3xl border border-white/5 flex flex-col items-center text-center group hover:bg-white/10 transition-colors">
              ...
              <div className="pt-16 border-t border-white/5 space-y-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i} className="flex justify-between items-center p-8 bg-black/40 rounded-[2.5rem] border border-white/5 btn-hover-effect relative overflow-hidden group">
                      <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                      <div className="relative z-10">
                        <p className="font-black text-white text-xl uppercase tracking-tight">{trigger.label}</p>
                        <div className="inline-flex mt-2 px-3 py-1 bg-primary/10 rounded-lg border border-primary/20">
                          <p className="text-[9px] font-black text-primary uppercase tracking-widest icon-neon-glow">{trigger.threshold}</p>
                        </div>
                      </div>
                      <div className="relative z-10 flex flex-col items-end">
                        <span className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1">PAYOUT</span>
              ...
              {/* Action Buttons */}
              <div className="pt-16 border-t border-white/5 flex flex-wrap gap-6">
                <Button className="flex-1 min-w-[200px] rounded-full bg-primary text-white font-black px-12 h-20 btn-hover-effect text-lg shadow-2xl">
                  <RefreshCw className="w-6 h-6 mr-4" /> RE-ACTIVATE
                </Button>
                <Button variant="outline" className="flex-1 min-w-[200px] rounded-full border-warning/40 text-warning hover:bg-warning/10 font-black px-12 h-20 btn-hover-effect text-lg">
                  <Pause className="w-6 h-6 mr-4" /> PAUSE
                </Button>
                <Button variant="outline" className="flex-1 min-w-[200px] rounded-full border-white/10 text-white/60 hover:text-white font-black px-12 h-20 btn-hover-effect text-lg">
                  <ArrowRightLeft className="w-6 h-6 mr-4" /> SWITCH TIER
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="lg:col-span-4 space-y-10">
            ...
            <Card className="card-neon-glow rounded-[3rem] border-none overflow-hidden">
              ...
              <CardContent className="p-12 space-y-8">
                {[
                  ...
                  <div key={i} className="p-6 bg-white/5 rounded-2xl border border-white/5 flex justify-between items-center group hover:bg-white/10 transition-colors">
            ...
            <Card className="card-neon-glow rounded-[3rem] border-none overflow-hidden">
              ...
              <CardContent className="p-10 space-y-4">
                <div className="p-4 bg-white/5 rounded-[1.5rem] border border-white/5 group hover:bg-white/10 transition-colors">
                  <Button variant="ghost" className="w-full justify-between h-16 rounded-xl font-black px-6">
                    <span className="flex items-center gap-4 text-white text-lg"><FileText className="w-6 h-6 text-primary icon-neon-glow" /> Policy Schedule</span>
                    <Download className="w-5 h-5 text-white/40 group-hover:text-white transition-colors" />
                  </Button>
                </div>
                <div className="p-4 bg-white/5 rounded-[1.5rem] border border-white/5 group hover:bg-white/10 transition-colors">
                  <Button variant="ghost" className="w-full justify-between h-16 rounded-xl font-black px-6">
                    <span className="flex items-center gap-4 text-white text-lg"><FileText className="w-6 h-6 text-primary icon-neon-glow" /> PDS & Terms</span>
                    <Download className="w-5 h-5 text-white/40 group-hover:text-white transition-colors" />
                  </Button>
                </div>
        ...
        <Card className="card-neon-glow rounded-[3rem] border-none overflow-hidden">
          <CardHeader className="bg-white/5 border-b border-white/5 px-12 py-10 flex flex-row justify-between items-center">
            ...
            <Table>
              <TableHeader className="bg-white/5">
                <TableRow className="border-white/5 hover:bg-transparent">
                  <TableHead className="font-black text-[10px] uppercase tracking-widest px-12 py-8 text-white/40">Reference Date</TableHead>
                  <TableHead className="font-black text-[10px] uppercase tracking-widest px-12 py-8 text-white/40">Internal ID</TableHead>
                  <TableHead className="font-black text-[10px] uppercase tracking-widest px-12 py-8 text-white/40">Amount</TableHead>
                  <TableHead className="font-black text-[10px] uppercase tracking-widest px-12 py-8 text-white/40">Method</TableHead>
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={i} className="border-white/5 hover:bg-white/5 transition-colors group">
                    ...
                    <TableCell className="px-12 py-10 font-mono text-[11px] font-black text-white/40 group-hover:text-white transition-colors">{row.id}</TableCell>
                    <TableCell className="px-12 py-10 font-black text-primary icon-neon-glow text-2xl">{row.amount}</TableCell>
                    <TableCell className="px-12 py-10 font-black text-white/60 text-sm uppercase">{row.method}</TableCell>
