    ...
    <DashboardLayout>
      <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <CardContent className="p-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 border-b border-border pb-10 mb-10">
              <div className="flex items-center gap-8">
                <div className="p-6 rounded-full bg-[#E0F7FA] text-primary shadow-inner">
                  <ShieldCheck className="w-12 h-12" />
                </div>
                <div>
                  <div className="flex items-center gap-4 mb-2">
                    <span className="text-2xl font-black text-[#006064] tracking-tight">POL-C349A4</span>
                    <Badge className="bg-primary text-white border-none text-[10px] font-bold px-4">ACTIVE</Badge>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="p-8 bg-[#F1F5F9]/30 rounded-2xl text-center border border-border/50">
          ...
          <CardContent className="p-10 pt-0">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              {[
                ...
                <div key={i} className="p-6 border border-border/60 rounded-2xl text-center flex flex-col items-center gap-3 bg-white hover:border-primary/30 transition-all shadow-sm">
                  <div className="w-3 h-3 rounded-full bg-primary shadow-[0_0_10px_rgba(0,172,193,0.4)] mb-2" />
                  <p className="text-[11px] font-bold text-[#006064] uppercase tracking-tight">{t.name}</p>
                  <p className="text-xl font-black text-primary">{t.payout}</p>
        ...
        <div className="flex flex-wrap gap-6">
          <Button className="bg-primary hover:bg-primary/90 text-white rounded-full font-black h-16 px-12 flex-1 sm:flex-none uppercase tracking-tight shadow-xl btn-hover-effect">Renew Policy</Button>
          ...
          <Button variant="outline" className="border-primary text-primary bg-white rounded-full font-black h-16 px-12 flex-1 sm:flex-none uppercase tracking-tight hover:bg-[#E0F7FA] btn-hover-effect">Change Tier</Button>
        </div>
        ...
        <Card className="bg-white border-none shadow-sm rounded-2xl overflow-hidden">
          <CardHeader className="px-10 py-8 border-b border-border">
            <CardTitle className="text-lg font-black text-[#006064] flex items-center gap-4">
              <div className="p-2 bg-[#E0F7FA] rounded-full"><History className="w-5 h-5 text-primary" /></div>
              Payment History
            </CardTitle>
          </CardHeader>
              ...
              <TableBody>
                <TableRow className="hover:bg-[#F1F5F9]/20 transition-colors">
                  ...
                  <TableCell className="px-10 py-6">
                    <Badge className="bg-primary/10 text-primary border-none text-[10px] font-bold px-3">SUCCESS</Badge>
                  </TableCell>
                  <TableCell className="px-10 py-6 text-right">
                    <Button variant="ghost" size="sm" className="text-primary font-black hover:bg-[#E0F7FA] rounded-full px-4">Download</Button>
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
